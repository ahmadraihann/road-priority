// src/modules/dashboard/views/index.tsx
import { ArrowRight, BarChart3, Map, Zap, Settings2 } from "lucide-react";
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-12 pb-16 md:pt-32 md:pb-40">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-slate-600 mb-10 max-w-3xl mx-auto leading-relaxed animate-fade-in delay-200">
              ...
              berdasarkan {criteria.length} kriteria dinamis untuk keputusan yang lebih objektif
              dan terukur
            </p>
            ...
            <div className="flex items-center justify-center gap-3 animate-fade-in delay-300">
              <Link to="/form">
                <Button
                  size="lg"
                  className="bg-linear-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white px-8 py-6 text-lg font-semibold rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
                >
                  Mulai Analisis
              ...
              <Link to="/criteria">
                <Button
                  size="lg"
                  variant="outline"
                  className="px-6 py-6 text-lg font-semibold rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105"
                >
            ...
            <div className="mt-10 md:mt-16 grid grid-cols-2 sm:grid-cols-3 gap-5 md:gap-8 max-w-2xl mx-auto animate-fade-in delay-400">
              <div className="text-center">
                ...
                <div className="text-sm text-slate-600">Kriteria Dinamis</div>
              </div>
              <div className="text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          <Card className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-0 bg-white/80 backdrop-blur-sm overflow-hidden">
            <CardContent className="md:p-8">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Metode TOPSIS</h3>
              <p className="text-slate-600 leading-relaxed">
                Analisis multi-kriteria yang terukur dan objektif untuk menentukan prioritas perbaikan jalan
              </p>
          ...
          <Card className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-0 bg-white/80 backdrop-blur-sm overflow-hidden">
            <CardContent className="md:p-8">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Visualisasi GIS</h3>
              <p className="text-slate-600 leading-relaxed">
                Lihat hasil prioritas langsung di peta dengan color coding yang jelas dan intuitif
              </p>
          ...
          <Card className="group hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border-0 bg-white/80 backdrop-blur-sm overflow-hidden">
            <CardContent className="md:p-8">
              ...
              <h3 className="text-xl font-bold text-slate-900 mb-3">Kriteria Dinamis</h3>
              <p className="text-slate-600 leading-relaxed">
                Tambah, ubah, dan kelola kriteria beserta bobotnya sesuai kebutuhan analisis
              </p>
      ...
      <section className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 md:pb-24">
        <div className="text-center pb-6 md:mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-slate-900 mb-4">
            {criteria.length} Kriteria Penilaian
          </h2>
          <p className="text-slate-600 max-w-2xl mx-auto">
            Sistem menganalisis berdasarkan kriteria yang dapat dikustomisasi dan terbobot
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
          {criteria.map((c, index) => {
            ...
            return (
              ...
              >
                <div className={`absolute top-0 left-0 w-1 h-full bg-linear-to-b ${color} rounded-l-xl`}></div>
                <div className="pl-4">
                  <div className="flex items-center justify-between mb-2">
                    <span className="text-xs font-semibold text-slate-500 uppercase tracking-wide">
                      {c.type === "cost" ? "Cost" : "Benefit"}
                    </span>
                    <span className={`text-sm font-bold bg-linear-to-r ${color} bg-clip-text text-transparent`}>
        ...
        {criteria.length === 0 && (
          <div className="text-center py-8">
            <p className="text-slate-500">Belum ada kriteria. <Link to="/criteria" className="text-indigo-600 font-medium hover:underline">Tambah kriteria</Link></p>
          </div>
        )}
      </section>
            ...
            <CardContent className="p-6 md:p-12 text-center relative">
              ...
              <div className="relative z-10">
                ...
                <p className="text-white/90 mb-8 max-w-2xl mx-auto">
                  Mulai sekarang dan dapatkan hasil analisis yang objektif dan terukur
                </p>
                <Link to="/form">
                  <Button size="lg" className="bg-white text-indigo-600 hover:bg-slate-50 px-8 py-6 text-lg font-semibold rounded-xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105">
                    Mulai Analisis
                    <ArrowRight className="ml-2 w-5 h-5" />
                  </Button>
                </Link>
